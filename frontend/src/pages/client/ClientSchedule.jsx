...
import MilestoneDetailsModal from '../staff/components/MilestoneDetailsModal';
...
const ClientSchedule = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // 1. Fetch Client Projects (now includes milestones)
                const projectsData = await clientAPI.getProjects();
    ...
    return (
        <div className="client-schedule-page">
                                ...
                                <div className="project-title-block">
                                    ...
                                    <div className="project-meta">
                                        ...
                                        <span className="meta-item budget">
                                            <FaMoneyBillWave /> ₹{project.budget?.toLocaleString('en-IN') || '0'}
                                        </span>
                                    </div>
                                </div>
                            </div>
