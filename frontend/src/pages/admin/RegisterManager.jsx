...
const RegisterManager = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const { data } = await api.post('/admin/create-manager', formDataToSend);

            if (!data.success) {
                throw new Error(data.message || 'Error creating manager');
            }
            ...
            // Redirect to manager list
            setTimeout(() => {
                navigate('/admin/managers');
            }, 2000);
        } catch (err) {
            setError(err.response?.data?.message || err.message || 'Error creating manager');
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="add-staff">
            ...
            {success && (
                <div style={{
                    ...
                    Manager registered successfully! Redirecting...
                </div>
            )}
